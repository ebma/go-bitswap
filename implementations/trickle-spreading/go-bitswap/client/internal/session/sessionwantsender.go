...
// or HAVE / DONT_HAVE
func (sws *sessionWantSender) Update(
	from peer.ID,
	ks []cid.Cid,
	haves []cid.Cid,
	dontHaves []cid.Cid,
...
// - newly available
// - newly unavailable
func (sws *sessionWantSender) processAvailability(
	availability map[peer.ID]bool,
) (avail []peer.ID, unavail []peer.ID) {
...
func (sws *sessionWantSender) checkForExhaustedWants(
	dontHaves []cid.Cid,
	newlyUnavailable []peer.ID,
) {
