...
func (bsm *blockstoreManager) getBlockSizes(
	ctx context.Context,
	ks []cid.Cid,
) (map[cid.Cid]int, error) {
...
func (bsm *blockstoreManager) getBlocks(
	ctx context.Context,
	ks []cid.Cid,
) (map[cid.Cid]blocks.Block, error) {
...
func (bsm *blockstoreManager) jobPerKey(
	ctx context.Context,
	ks []cid.Cid,
	jobFn func(c cid.Cid),
) error {
	var err error
